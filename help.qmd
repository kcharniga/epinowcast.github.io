...
Real-time infectious disease modelling can be challenging and we often need to produce results on a short timeline. Whislt we have tried to make our tooling as easy to use as possible there will inevitably be times when there are issues or even mistakes.
